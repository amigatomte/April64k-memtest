...
//ZP_FAILLO    = $F4   // First failing address (low .byte)
//ZP_FAILHI    = $F5   // First failing address (high .byte)
//ZP_STATUS    = $F6   // 0 = pass, 1 = fail
//ZP_FAILBITS  = $F7   // Failed bits (difference)
...
// ---------------------------------------------------------
        lda #$30                                //Bank out I/O, kernal and basic
        sta $01     
                // jsr flickerscreen
