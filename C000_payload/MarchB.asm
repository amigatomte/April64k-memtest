...
// .label ZP_FAILLO    = $F4   // First failing address (low .byte)
// .label ZP_FAILHI    = $F5   // First failing address (high .byte)
// .label ZP_STATUS    = $F6   // 0 = pass, 1 = fail
// .label ZP_FAILBITS  = $F7   // Failed bits (difference)
